...
class Options:
    ...
    def initialize_parser(self):
        ...
        self.parser.add_argument(
            ...
            type=str,
            default=None,
            help="Wandb run name (defaults to experiment name)",
        )
        self.parser.add_argument(
            "--model_path",
            type=str,
    ...
    def add_modeling_options(self):
        ...
        self.parser.add_argument(
            "--use_grpo",
            action="store_true",
            help="Use GRPO (Group Relative Policy Optimization) instead of standard REINFORCE",
        )
        ...
        self.parser.add_argument(
            ...
            type=int,
            default=4,
            help="Number of responses to generate per group for GRPO",
        )
        ...
        self.parser.add_argument(
            ...
            type=float,
            default=0.2,
            help="PPO clipping epsilon for GRPO (clips probability ratio to [1-ε, 1+ε])",
        )

        self.parser.add_argument(
            "--grpo_train_retriever",
            action="store_true",
            help="Enable joint GRPO training for both retriever and generator (default: generator-only)",
        )

        self.parser.add_argument(
            "--grpo_retriever_group_size",
            type=int,
            default=5,
            help="Number of documents to sample per group for retriever GRPO (k in the algorithm)",
        )
        ...
        self.parser.add_argument(
            ...
            type=float,
            default=0.5,
            help="Ratio of top responses to use for advantage computation",
        )
        ...
        self.parser.add_argument(
            ...
            type=str,
            default=None,
            help="Path to reference model for KL computation in GRPO (if None, uses copy of initial model)",
        )
